...
final class ParagraphsConfigurator implements FieldConfiguratorInterface
{
    ...
    public function configure(FieldDto $fieldDto, EntityDto $entityDto, AdminContext $adminContext): void
    {
        ...
        $cssClasses = ('' === $breakpointName) ? 'flex-fill' : sprintf('d-none d-%s-flex flex-%s-fill', $breakpointName, $breakpointName);

        $fieldDto->setFormTypeOption('row_attr.class', $fieldDto->getFormTypeOption('row_attr.class').' '.$cssClasses);
    }
