...
class SerieType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $formBuilder, array $options): void
    {
        ...
        $formBuilder->add(
            ...
            [
                'required' => false,
                'choices'  => $this->serieService->getCountryForForm(),
            ]
        );
        $formBuilder->add(
            'categories',
            ...
            [
                'required' => false,
                'choices'  => $this->serieService->getCategoryForForm(),
            ]
        );
        $formBuilder->add(
            'sagas',
            ...
            [
                'required' => false,
                'choices'  => $this->serieService->getSagaForForm(),
            ]
        );
        $formBuilder->add(
            'year',
            ...
            [
                ...
                'choices'  => $this->serieService->getYearForForm(),
            ]
        );
