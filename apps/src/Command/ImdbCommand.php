...
class ImdbCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $type = $symfonyStyle->choice(
            'Voulez-vous traiter un film ou une série ?',
            [
                'film',
                'série',
            ]
        ...
        $details = ($type == 'film') ? $this->movieService->getDetailsTmdb($imdb) : $this->serieService->getDetailsTmdb($imdb);
        if (null === $details) {
        ...
        $serie = $this->serieRepository->findOneBy(['imdb' => $imdb]);
