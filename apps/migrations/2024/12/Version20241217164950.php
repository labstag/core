 ...
 */
final class Version20241217164950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE block (id INT AUTO_INCREMENT NOT NULL, content LONGTEXT DEFAULT NULL, enable TINYINT(1) DEFAULT 1 NOT NULL, pages LONGTEXT DEFAULT NULL, position INT DEFAULT 1 NOT NULL, region VARCHAR(255) NOT NULL, request_path TINYINT(1) NOT NULL, roles JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', slug VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_831B9722989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, slug VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_64C19C1727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE category_story (category_id INT NOT NULL, story_id INT NOT NULL, INDEX IDX_3654B7112469DE2 (category_id), INDEX IDX_3654B71AA5D4036 (story_id), PRIMARY KEY(category_id, story_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE chapter (id INT AUTO_INCREMENT NOT NULL, meta_id INT NOT NULL, refstory_id INT NOT NULL, enable TINYINT(1) DEFAULT 1 NOT NULL, slug VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, img VARCHAR(255) DEFAULT NULL, position INT DEFAULT 1 NOT NULL, resume LONGTEXT DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, state JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', state_changed DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_F981B52E989D9B62 (slug), UNIQUE INDEX UNIQ_F981B52E39FCA6F9 (meta_id), INDEX IDX_F981B52E1A01F29B (refstory_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE configuration (id INT AUTO_INCREMENT NOT NULL, copyright VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, favicon VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, noreply VARCHAR(255) NOT NULL, placeholder VARCHAR(255) DEFAULT NULL, title_format VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, user_link TINYINT(1) NOT NULL, user_show TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE edito (id INT AUTO_INCREMENT NOT NULL, refuser_id INT DEFAULT NULL, enable TINYINT(1) DEFAULT 1 NOT NULL, title VARCHAR(255) NOT NULL, img VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, state JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', state_changed DATETIME DEFAULT NULL, INDEX IDX_F2EC5FE02B445CEF (refuser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE geo_code (id INT AUTO_INCREMENT NOT NULL, accuracy INT NOT NULL, community_code VARCHAR(20) NOT NULL, community_name VARCHAR(100) NOT NULL, country_code VARCHAR(2) NOT NULL, latitude VARCHAR(255) NOT NULL, longitude VARCHAR(255) NOT NULL, place_name VARCHAR(180) NOT NULL, postal_code VARCHAR(20) NOT NULL, province_code VARCHAR(20) NOT NULL, province_name VARCHAR(100) NOT NULL, state_code VARCHAR(20) NOT NULL, state_name VARCHAR(100) NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE link (id INT AUTO_INCREMENT NOT NULL, block_id INT DEFAULT NULL, blank TINYINT(1) NOT NULL, classes VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, INDEX IDX_36AC99F1E9ED820C (block_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE memo (id INT AUTO_INCREMENT NOT NULL, refuser_id INT DEFAULT NULL, enable TINYINT(1) DEFAULT 1 NOT NULL, title VARCHAR(255) NOT NULL, img VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, state JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', state_changed DATETIME DEFAULT NULL, INDEX IDX_AB4A902A2B445CEF (refuser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE meta (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) DEFAULT NULL, keywords VARCHAR(255) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE page (id INT AUTO_INCREMENT NOT NULL, meta_id INT NOT NULL, page_id INT DEFAULT NULL, refuser_id INT DEFAULT NULL, enable TINYINT(1) DEFAULT 1 NOT NULL, slug VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, img VARCHAR(255) DEFAULT NULL, resume LONGTEXT DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, state JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', state_changed DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_140AB620989D9B62 (slug), UNIQUE INDEX UNIQ_140AB62039FCA6F9 (meta_id), INDEX IDX_140AB620C4663E4 (page_id), INDEX IDX_140AB6202B445CEF (refuser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE paragraph (id INT AUTO_INCREMENT NOT NULL, block_id INT DEFAULT NULL, chapter_id INT DEFAULT NULL, edito_id INT DEFAULT NULL, memo_id INT DEFAULT NULL, page_id INT DEFAULT NULL, post_id INT DEFAULT NULL, story_id INT DEFAULT NULL, content LONGTEXT DEFAULT NULL, enable TINYINT(1) DEFAULT 1 NOT NULL, fond VARCHAR(255) DEFAULT NULL, img VARCHAR(255) DEFAULT NULL, nbr INT DEFAULT NULL, position INT NOT NULL, title VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, url VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_7DD39862E9ED820C (block_id), INDEX IDX_7DD39862579F4768 (chapter_id), INDEX IDX_7DD398625B3CFAAA (edito_id), INDEX IDX_7DD39862B4D32439 (memo_id), INDEX IDX_7DD39862C4663E4 (page_id), INDEX IDX_7DD398624B89032C (post_id), INDEX IDX_7DD39862AA5D4036 (story_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, meta_id INT NOT NULL, refuser_id INT DEFAULT NULL, enable TINYINT(1) DEFAULT 1 NOT NULL, slug VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, img VARCHAR(255) DEFAULT NULL, resume LONGTEXT DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, state JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', state_changed DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_5A8A6C8D989D9B62 (slug), UNIQUE INDEX UNIQ_5A8A6C8D39FCA6F9 (meta_id), INDEX IDX_5A8A6C8D2B445CEF (refuser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE star (id INT AUTO_INCREMENT NOT NULL, description LONGTEXT DEFAULT NULL, enable TINYINT(1) DEFAULT 1 NOT NULL, forks INT NOT NULL, language VARCHAR(255) DEFAULT NULL, license VARCHAR(255) DEFAULT NULL, repository VARCHAR(255) NOT NULL, stargazers INT NOT NULL, title VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, watchers INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE story (id INT AUTO_INCREMENT NOT NULL, meta_id INT NOT NULL, refuser_id INT DEFAULT NULL, enable TINYINT(1) DEFAULT 1 NOT NULL, slug VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, img VARCHAR(255) DEFAULT NULL, resume LONGTEXT DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, state JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', state_changed DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_EB560438989D9B62 (slug), UNIQUE INDEX UNIQ_EB56043839FCA6F9 (meta_id), INDEX IDX_EB5604382B445CEF (refuser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tag (id INT AUTO_INCREMENT NOT NULL, slug VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tag_chapter (tag_id INT NOT NULL, chapter_id INT NOT NULL, INDEX IDX_CBB09884BAD26311 (tag_id), INDEX IDX_CBB09884579F4768 (chapter_id), PRIMARY KEY(tag_id, chapter_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tag_story (tag_id INT NOT NULL, story_id INT NOT NULL, INDEX IDX_C9BA1D3EBAD26311 (tag_id), INDEX IDX_C9BA1D3EAA5D4036 (story_id), PRIMARY KEY(tag_id, story_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE template (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, html LONGTEXT DEFAULT NULL, text LONGTEXT DEFAULT NULL, title VARCHAR(255) NOT NULL, deleted_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, avatar VARCHAR(255) DEFAULT NULL, email VARCHAR(180) NOT NULL, enable TINYINT(1) DEFAULT 1 NOT NULL, language VARCHAR(2) DEFAULT \'fr\' NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', username VARCHAR(255) NOT NULL, deleted_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, state JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', state_changed DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
