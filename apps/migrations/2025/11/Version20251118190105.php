 ...
 */
final class Version20251118190105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD json JSON DEFAULT NULL');
        $this->addSql('ALTER TABLE saga ADD json JSON DEFAULT NULL');
        $this->addSql('ALTER TABLE season ADD json JSON DEFAULT NULL');
        $this->addSql('ALTER TABLE serie ADD json JSON DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie DROP json');
        $this->addSql('ALTER TABLE saga DROP json');
        $this->addSql('ALTER TABLE season DROP json');
        $this->addSql('ALTER TABLE serie DROP json');
    }
}
