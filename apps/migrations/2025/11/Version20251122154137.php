...
final class Version20251122154137 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `group` (id CHAR(36) NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE group_user (group_id CHAR(36) NOT NULL, user_id CHAR(36) NOT NULL, INDEX IDX_A4C98D39FE54D947 (group_id), INDEX IDX_A4C98D39A76ED395 (user_id), PRIMARY KEY (group_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE permission (id CHAR(36) NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE permission_group (permission_id CHAR(36) NOT NULL, group_id CHAR(36) NOT NULL, INDEX IDX_BB4729B6FED90CCA (permission_id), INDEX IDX_BB4729B6FE54D947 (group_id), PRIMARY KEY (permission_id, group_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE recommendation (id CHAR(36) NOT NULL, overview LONGTEXT DEFAULT NULL, poster VARCHAR(255) DEFAULT NULL, release_date DATE NOT NULL, title VARCHAR(255) NOT NULL, tmdb VARCHAR(255) DEFAULT NULL, refmovie_id CHAR(36) DEFAULT NULL, refsaga_id CHAR(36) DEFAULT NULL, refserie_id CHAR(36) DEFAULT NULL, INDEX IDX_433224D23FCF0451 (refmovie_id), INDEX IDX_433224D23EE66154 (refsaga_id), INDEX IDX_433224D2691F3A10 (refserie_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
