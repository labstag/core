 ...
 */
final class Version20251023093209 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE season (air_date DATE DEFAULT NULL, id CHAR(36) NOT NULL, img VARCHAR(255) DEFAULT NULL, number INT DEFAULT NULL, overview LONGTEXT DEFAULT NULL, tmdb VARCHAR(255) DEFAULT NULL, vote_average DOUBLE PRECISION DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, refserie_id CHAR(36) DEFAULT NULL, INDEX IDX_F0E45BA9691F3A10 (refserie_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE serie (adult TINYINT(1) NOT NULL, certification VARCHAR(255) DEFAULT NULL, citation VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, countries JSON DEFAULT NULL, description LONGTEXT DEFAULT NULL, enable TINYINT(1) DEFAULT 1 NOT NULL, evaluation DOUBLE PRECISION DEFAULT NULL, file TINYINT(1) NOT NULL, id CHAR(36) NOT NULL, imdb VARCHAR(255) NOT NULL, img VARCHAR(255) DEFAULT NULL, lastrelease_date DATE DEFAULT NULL, release_date DATE DEFAULT NULL, title VARCHAR(255) NOT NULL, tmdb VARCHAR(255) DEFAULT NULL, trailer LONGTEXT DEFAULT NULL, votes INT DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, meta_id CHAR(36) NOT NULL, UNIQUE INDEX UNIQ_AA3A9334989D9B62 (slug), UNIQUE INDEX UNIQ_AA3A933485489131 (imdb), UNIQUE INDEX UNIQ_AA3A933439FCA6F9 (meta_id), INDEX IDX_SERIE_SLUG (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE paragraph CHANGE refmovie_id serie_id CHAR(36) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paragraph CHANGE serie_id refmovie_id CHAR(36) DEFAULT NULL');
